...
.search-box input:focus {{ border-color: #FF5858; }}
.entry {{
  padding: 14px 0 4px;
...
<footer>
  Auto-generated from
  <a href="https://github.com/fagramdesktop/fadesktop/blob/dev/changelog.txt">changelog.txt</a>.
  Source code is published under
  <a href="https://github.com/fagramdesktop/fadesktop">GPL v3</a>.
</footer>
